...
@section('konten')
    <div class="main w-full">
        ...
        <div style="background-image: url('/aset/bg-sch.pngg')" class="bg-white bg-cover bg-center bg-opacity-50 backdrop-blur-md w-full md:p-20 p-8 max-md:mt-20">
            ...
            <div class="more w-full md:py-5 md:px-20 md:mt-10 mt-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 items-center gap-2 mt-5">
                    <a href="#data-alumni" class="cursor-pointer">
                        <div class="flex flex-col w-auto bg-gray-800 text-white bg-opacity-100 backdrop-blur-sm justify-center items-center gap-2 p-5 rounded-lg">
                ...
                {{-- <div class="list w-full grid md:grid-cols-4 grid-cols-2 gap-4 items-center md:mt-5">
                    <div class="list-data flex w-full gap-4 items-center md:p-4 p-2 rounded-lg bg-white shadow-lg">
                        ...
                        <div class="data">
                            ...
                            <h1 class="md:text-lg text-sm capitalize">teknik mesin</h1>
                        </div>
                    </div>
                    <div class="list-data flex w-full gap-4 items-center md:p-4 p-2 rounded-lg bg-white shadow-lg">
                        <img src="{{ url('aset/unair.png') }}" alt="" class="w-auto h-20">
                        <div class="data">
                            <h1 class="md:text-2xl text-xl font-semibold capitalize">dharma fattahul winzi</h1>
